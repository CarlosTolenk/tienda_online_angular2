...
module.exports.insertarUsuario = function (callback) {
	let User1 = new Usuario({nombre: "Nombre de usuario 1", email: 'carlos.tolentinoe@gmail.com', password:'clave01'});
...
module.exports.eliminarUsuario = function (callback) {
	Usuario.remove({email: 'carlos.tolentinoe@gmail.com'}, (error) => {
		if(error) callback(error);
